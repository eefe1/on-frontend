...
import { doctordashboardprofile01, doctordashboardprofile02, doctordashboardprofile04, doctordashboardprofile05, doctordashboardprofile06, doctordashboardprofile07, doctordashboardprofile08, doctordashboardprofile3 } from "../../components/imagepath";
import { Filter, initialSettings } from "../../components/common/filter";
              ...
              <div className="col-md-12 col-12 text-center">
                <nav aria-label="breadcrumb" className="page-breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active">Randevular</li>
                  </ol>
                  <h2 className="breadcrumb-title">Randevular</h2>
                </nav>
              </div>
            </div>
          </div>
                ...
                <ul className="header-list-btns">
                  ...
                  <li>
                    <div className="view-icons">
                      <Link to="/avukat/panel/randevular" className="active">
                      ...
                      <li>
                        <div className="patinet-information">
                          ...
                          <div className="patient-info">
                            <p>#Apt0001</p>
                            <h6>
                              <Link to="/doctor/doctor-upcoming-appointment">Ayhan Dalgıç</Link>
                            </h6>
                          </div>
                        </div>
                      </li>
                      ...
                      <li>
                        <div className="patinet-information">
                          ...
                          <div className="patient-info">
                            <p>#Apt0002</p>
                            <h6>
                              <Link to="/doctor/doctor-upcoming-appointment">Hüseyin Atay</Link>
                      ...
                      <li>
                        <div className="patinet-information">
                          ...
                          <div className="patient-info">
                            <p>#Apt0003</p>
                            <h6>
                              <Link to="/doctor/doctor-upcoming-appointment">Yasemin Kaya</Link>
                            </h6>
                          </div>
                        </div>
                      </li>
