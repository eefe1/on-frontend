              ...
              <div className="col-md-12 col-12 text-center">
                <nav aria-label="breadcrumb" className="page-breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active">Avukat Bekleyen Blog</li>
                  </ol>
                  <h2 className="breadcrumb-title">Avukat Bekleyen Blog</h2>
                </nav>
              </div>
            </div>
          </div>
                              ...
                              <div className="post-author">
                                <Link to="avukat_profil">
                                  <ImageWithBasePath
                                    ...
                                    alt="Post Author"
                                  />{" "}
                                  <span>Pelin Yılmaz</span>
                                </Link>
                              </div>
                            </li>
                            <li>
                              <i className="far fa-clock" /> 4 Haziran 2025
                            </li>
                          </ul>
                        ...
                        <div className="row pt-3">
                          <div className="col">
                            <Link to="/blog/doctor-edit-blog" className="text-success">
                              <i className="far fa-edit" /> Düzenle
                            </Link>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="blog grid-blog">
                        ...
                        <div className="blog-content">
                          <ul className="entry-meta meta-item">
                            ...
                            <li>
                              <i className="far fa-clock" /> 3 Haziran 2025
                            </li>
                          </ul>
                          <h3 className="blog-title">
                            <Link to="/blog/blog-details">
