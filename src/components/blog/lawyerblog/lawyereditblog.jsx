                  ...
                  <div className="profile-sidebar doctor-sidebar profile-sidebar-new">
                    <div className="widget-profile pro-widget-content">
                      <div className="profile-info-widget">
                        ...
                        <div className="profile-det-info">
                          <h3>
                            <Link to="avukat_profil">Dr Edalin Hendry</Link>
                          </h3>
                    ...
                    <div className="dashboard-widget">
                      <nav className="dashboard-menu">
                        <ul>
                          <li>
                            <Link to="/avukat/avukat-panel">
                              <i className="fa-solid fa-shapes" />
                              <span>Dashboard</span>
                            </Link>
                          </li>
                          <li>
                            <Link to="/avukat/panel/istekler">
                          ...
                          <li>
                            <Link to="/avukat/panel/takvim">
                              <i className="fa-solid fa-calendar-day" />
                              <span>Available Timings</span>
                            </Link>
                          </li>
                          <li>
                            <Link to="/avukat/panel/muvekkil">
                              <i className="fa-solid fa-user-injured" />
                              <span>My Patients</span>
                            </Link>
                          </li>
                          <li>
                            <Link to="/avukat/panel/uzmanlik">
                          ...
                          <li>
                            <Link to="/avukat/panel/odemeler">
                              <i className="fa-solid fa-money-bill-1" />
                              <span>Payout Settings</span>
                            </Link>
                          </li>
                          <li>
                            <Link to="/avukat/panel/chat">
                          ...
                          <li>
                            <Link to="/avukat/panel/sosyal-medya">
                              <i className="fa-solid fa-shield-halved" />
                              <span>Social Media</span>
                            </Link>
                          </li>
                          <li>
                            <Link to="/avukat/parola-degistir">
